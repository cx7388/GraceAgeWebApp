...
<head>
  ...
  <script type="text/javascript" src="<?=base_url()?>assets/js/loginOlderAdults.js"></script>
...
<?php else: ?>
      ...
      <div class="older col-md-6"  onclick="popup()">
        <form id="chooseElder" method="post">
          <label for="<?php echo $elder->ProfileID;?>">
              <img  style="height:300px;width:300px;object-fit: cover;"src="<?=base_url()?>upload/<?php echo $elder->pictureURL;?>" alt="Avatar" onerror = "this.src='<?=base_url()?>upload/default.png';"  class="image img-responsive">
            <div class="middle">
...
<div class="col-md-4" id="box1">
    <div  id="overlay"><?php echo $this->lang->line('upload_pics');?></div>
  <div class="col-md-4"></div>
<?php else:?>
<div class="col-md-4"></div>
<div class="col-md-4" id="box1">
    ...
    <div class="w3-modal-content">
      ...
      <div class="w3-container">
        ...
        <form id="login_form" method='post' class="login_form">
          <br>
          <a><?php echo $this->lang->line('enter_password');?></a>
          <br/>
          <br>
          <input type="password" style = "text-align:center;"inputmode="numeric" size="4" id="inputText" name="password" type="text" class="form-control col-md-6 offset-md-3" placeholder="<?php echo $this->lang->line('enter_password');?>"/>
...
function selectedElderly(obj){
  ...
  $.ajax({ //ajax syntax
    type: "POST",
    url: "<?= base_url() ?>index.php/AlbumController/getLogin", //run this function in controller
...
function selectedDepartment(obj){
  ...
  $.ajax({
    type: "POST",
    url: "<?= base_url() ?>index.php/AlbumController/getRooms",
